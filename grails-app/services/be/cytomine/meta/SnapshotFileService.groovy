...
class SnapshotFileService extends ModelService {
     ...
     */
    def list() {
        return SnapshotFile.list()
    }

    def list(Long domainIdent,String domainClassName) {
        return SnapshotFile.findAllByDomainIdentAndDomainClassName(domainIdent,domainClassName)
    }
     ...
     */
    def delete(SnapshotFile domain, Transaction transaction = null, Task task = null, boolean printMessage = true) {
